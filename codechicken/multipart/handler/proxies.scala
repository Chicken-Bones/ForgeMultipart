...
class MultipartProxy_serverImpl
{
    def preInit(cfgdir:File)
    {
        ...
        MultipartGenerator.registerTrait("net.minecraft.inventory.IInventory", "codechicken.multipart.scalatraits.TIInventoryTile")
        MultipartGenerator.registerTrait("net.minecraft.inventory.ISIdedInventory", "codechicken.multipart.scalatraits.TIInventoryTile")
